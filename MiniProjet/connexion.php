...
if(isset($_POST['btn-form'])){
    if($_POST['login']!='' && $_POST['password']!=''){
        ...
        if($result=="error"){
            ...
            $users=getData();
            $connecter=getUser($login,$password,$users);
            $_SESSION['user']=$connecter;
    ...
    <div class="contener-body">
        <form action="" method="POST" id="form-connexion">
            ...
            <div class="input-form" >
                ...
                <div class="error-form" id="error-2"><?php if (isset($erreur)){ ?><span class="error-form" ><?= $erreur?></span><?php }?></div>
            </div>
            <div class="input-form">
